...
public class WheelView extends View {
	...
	public static int VALUE_TEXT_COLOR = 0xF0000000;

	/** Items text color */
	public static int ITEMS_TEXT_COLOR = 0xFF000000;
	...
	private void screenCheck(Context context){
		ADDITIONAL_ITEM_HEIGHT = ScreenUtil.dip2px(context, 9);
		TEXT_SIZE = ScreenUtil.sp2px(context, 16);
	}
...
//		screenCheck(context);
	...
	public boolean getScrollable(boolean scrollable){
		return scrollable;
	}
...
//		}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (itemsWidth > 0) {
			...
			canvas.translate(PADDING, -(ITEM_OFFSET-5));
			drawItems(canvas);
			drawValue(canvas);
			canvas.restore();
		}
	...
	private void drawShadows(Canvas canvas) {
		topShadow.setBounds(0, 5, getWidth(), getHeight() / visibleItems);
