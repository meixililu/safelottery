 ...
 */
public abstract class TypeMapHttpResponseHandler extends TextHttpResponseHandler {
	 ...
	 */
	public TypeMapHttpResponseHandler(Context mContext, boolean isToastError) {
	 ...
	 * Creates new JsonHttpResponseHandler, with Json String encoding UTF-8
	 */
	public TypeMapHttpResponseHandler() {
		super(DEFAULT_CHARSET);
	}
	 ...
	 */
	public TypeMapHttpResponseHandler(String encoding) {
		super(encoding);
	}
	 ...
	 */
	public abstract void onSuccess(int statusCode, Map mMap);
