 ...
 */
public abstract class TypeSafelotteryHttpResponseHandler extends TextHttpResponseHandler {

	private boolean isToastError;
	private Context mContext;
	private Parser<? extends SafelotteryType> parser;
	 ...
	 */
	public TypeSafelotteryHttpResponseHandler(Context mContext, boolean isToastError, Parser<? extends SafelotteryType> parser) {
	 ...
	 * Creates new JsonHttpResponseHandler, with Json String encoding UTF-8
	 */
	public TypeSafelotteryHttpResponseHandler() {
		super(DEFAULT_CHARSET);
	}
	 ...
	 */
	public TypeSafelotteryHttpResponseHandler(String encoding) {
		super(encoding);
	}
	 ...
	 */
	public abstract void onSuccess(int statusCode, SafelotteryType response);
										...
										if (!TextUtils.isEmpty(mResult.getCode())) {
											if (!mResult.getCode().equals(SystemInfo.succeeCode)) {
												...
												if (!TextUtils.isEmpty(resultStr)) {
													...
													base = parser.parse(json);
													onSuccess(statusCode, base);
												} else {
