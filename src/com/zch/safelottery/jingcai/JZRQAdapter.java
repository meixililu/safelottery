...
public class JZRQAdapter extends JCAdapter{

	private Context mContext;
	private int danCount;
	
	public JZRQAdapter(Context context,ArrayList<JZMatchBean> selectedBeans,LayoutInflater inflater,int dan) {
	...
	public View getViews(int position, View convertView, ViewGroup parent) {
		...
		holder.txTouzhu.setText( codeToText(bean.getSelectedList()) );
