...
import com.zch.safelottery.custom_control.AmazingAdapter.HasMorePagesListener;
...
//		if(ev.getY() < mHeaderViewHeight){
//			Toast.makeText(getContext(), "--", 0).show();
//			Log.d("Activity", "Y---"+ev.getY());
//			return false;
//		}
...
//	}
    ...
    public void scrollLitter() {
//		LogUtil.DefalutLog("scrollLitter:"+getScrollY());
	}
