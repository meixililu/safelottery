package com.zch.safelottery.order;
...
//			LogUtil.CustomLog("TAG", "position :: " + position+ " ... " + mAdapter.getCount());
//			LogUtil.CustomLog("TAG", "convertView :: " + convertView);
			
			position = position < mAdapter.getCount() ? position: mAdapter.getCount() - 1;
			if (convertView != null) {
