	...
	private void initView(){
		...
		explainBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(P5Activity.this, HelpDetailActivity.class);
...
//		autoViews.add(null);
	...
	public void onBackPressed() {
			if(methodUtil.clearBottom(arrayNum) || lotteryBeans.size() > 0){
				NormalAlertDialog dialog = new NormalAlertDialog(P5Activity.this);
				dialog.setTitle("提示");
	...
	public void bottom_clear(View v) {
		if (methodUtil.clearBottom(arrayNum)) {
	...
	public void bottom_random(View v) {
		...
		data.add(10);
		data.add(50);
		JXDialog dialog = new JXDialog(P5Activity.this, data);
	...
	private void startActivity(){
		...
		intent.setClass(P5Activity.this, CtOrderListActivity.class);
	...
	private void stateNumber(){
		if(popDialog == null){
			popDialog = new PopDialog(P5Activity.this,R.style.popDialog);
			...
			popDialog.setListener(new PopViewItemOnclickListener(){
				...
				public void onThirdClick(View v) {
					...
					mBundle.putString(Settings.INTENT_STRING_LOTTERY_ID, LotteryId.PL5);
					if(GetString.isLogin){
						Intent intent  = new Intent(P5Activity.this,RecordBetActivity.class);
						intent.putExtra(Settings.BUNDLE,mBundle);
						startActivity(intent);
					}else{
						Intent intent  = new Intent(P5Activity.this,LoginActivity.class);
						intent.putExtra(Settings.BUNDLE,mBundle);
	...
	private void randomTask(final int num) {
		MyAsyncTask tast = new MyAsyncTask(P5Activity.this);
