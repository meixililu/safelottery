...
public class D3Activity extends BaseLotteryActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LogUtil.DefalutLog("cost-time:"+(end-start));
	}
	...
	public void onBackPressed() {
			if (arrayNum[0] > 0 || arrayNum[1] > 0 || arrayNum[2] > 0 || arrayNum[3] > 0 || arrayNum[4] > 0 || lotteryBeans.size() > 0) {
				NormalAlertDialog dialog = new NormalAlertDialog(D3Activity.this);
				dialog.setTitle("提示");
	...
	public void bottom_random(View v) {
		...
		data.add(10);
		data.add(50);
		JXDialog dialog = new JXDialog(D3Activity.this, data);
	...
	private void startActivity() {
		...
		intent.setClass(D3Activity.this, CtOrderListActivity.class);
	...
	private void stateNumber(){
		if(popDialog == null){
			popDialog = new PopDialog(D3Activity.this,R.style.popDialog);
			...
			popDialog.setListener(new PopViewItemOnclickListener(){
				...
				public void onThirdClick(View v) {
					...
					mBundle.putString(Settings.INTENT_STRING_LOTTERY_ID, LotteryId.FC);
					if(GetString.isLogin){
						Intent intent  = new Intent(D3Activity.this,RecordBetActivity.class);
						intent.putExtra(Settings.BUNDLE,mBundle);
						startActivity(intent);
					}else{
						Intent intent  = new Intent(D3Activity.this,LoginActivity.class);
						intent.putExtra(Settings.BUNDLE,mBundle);
				...
				public void onFourthClick(View v) {
					...
					mBundle.putString(Settings.INTENT_STRING_LOTTERY_ID, LotteryId.FC);
					Intent intent = new Intent();
					intent.setClass(D3Activity.this, LotteryResultHistoryActivity.class);
					intent.putExtra(Settings.BUNDLE,mBundle);
					startActivity(intent);
				}
	...
	private void randomTask(final int num){
		MyAsyncTask tast = new MyAsyncTask(D3Activity.this);
